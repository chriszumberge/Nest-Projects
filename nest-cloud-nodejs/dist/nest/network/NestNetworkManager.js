...
var NetworkManagerErrors = require('./NetworkManagerErrors');
var NestNetworkManagerUtils = require('./NestNetworkManagerUtils');
var EMITABLE_EVENTS = require('./NestNetworkManagerContants').EMITABLE_EVENTS;
var NETWORK_STREAM_EVENTS = require('./NestNetworkManagerContants').NETWORK_STREAM_EVENTS;
var NETWORK_ERROR_EVENTS = require('./NestNetworkManagerContants').NETWORK_ERROR_EVENTS;
...
var NestNetworkManager = function (_EventEmitter) {
    _inherits(NestNetworkManager, _EventEmitter);

    /** @constructor */
    function NestNetworkManager() {
        _classCallCheck(this, NestNetworkManager);

        var _this = _possibleConstructorReturn(this, (NestNetworkManager.__proto__ || Object.getPrototypeOf(NestNetworkManager)).call(this));

        _this.accessToken = null;
        _this.serviceStream = null;
        _this.isUnderRateLimitation = false;
        _this.autoReinitStream = false;
        _this.cachedRedirectUrl = null;
        _this.boundStreamListener = _this._determineStreamUpdateType.bind(_this);

        _this.apiUrl = "https://developer-api.nest.com";

        _this.STREAM_EVENT_BODY_PROCESSING_MAP = _defineProperty({}, NETWORK_STREAM_EVENTS.auth_revoked, _this._processAuthTokenRevokedEvent.bind(_this));

        _this.STREAM_EVENT_EMISSION_OPERATION_MAP = _defineProperty({}, NETWORK_STREAM_EVENTS.put, _this._emitServiceStreamDataUpdateEvent.bind(_this));

        _this.reservedErrorCodes = {
            307: _this._handleRedirect,
            400: _this._handleInvalidRequest,
            404: _this._handleNotFound,
            500: _this._handleInternalAPIError,
            401: _this._handleAuthError,
            403: _this._handleForbidden,
            503: _this._handleServiceUnavailable,
            429: _this._handleBlocked
        };

        _this.chunkedPutMessagesAwaitingCompletion = [];
        return _this;
    }
    ...
    _createClass(NestNetworkManager, [{
        key: 'setAutoReinitStream',
        value: function setAutoReinitStream(shouldAutoReinit) {
        ...
        key: '_cacheRedirectUrl',
        value: function _cacheRedirectUrl(redirectUrl) {

            this.cachedRedirectUrl = ["https://", redirectUrl.split("/")[2]].join("");
        }
        ...
        key: '_wipeCachedRedirectUrl',
        value: function _wipeCachedRedirectUrl() {
        ...
        key: '_processAuthTokenRevokedEvent',
        value: function _processAuthTokenRevokedEvent(eventContainer) {
        ...
        key: '_cleanupServiceStream',
        value: function _cleanupServiceStream() {
        ...
        key: '_determineIfChunkedMessagesHaveCompleted',
        value: function _determineIfChunkedMessagesHaveCompleted() {

            var parsedBody;

            try {

                parsedBody = JSON.parse(this.chunkedPutMessagesAwaitingCompletion.join(""));
            } catch (e) {
        ...
        key: '_wipeChunkedMessageQueue',
        value: function _wipeChunkedMessageQueue() {
        ...
        key: '_attemptToParseUpdate',
        value: function _attemptToParseUpdate(body) {

            var checkForChunkedMessage = /event\: /;
            var rawBodyExtraction = NestNetworkManagerUtils.splitStringByNewlines(body);
            ...
            if (!checkForChunkedMessage.test(body)) {
                ...
                eventContainer.event = NestNetworkManagerUtils.extractStreamUpdateEventType(rawBodyExtraction);

                if (eventContainer.event === "put") {

                    processedEventBody = NestNetworkManagerUtils.extractAndParseStreamUpdateEventBody(rawBodyExtraction);
                    ...
                    if (processedEventBody.parsed === false) {
                        ...
                        this._wipeChunkedMessageQueue();
                        this.chunkedPutMessagesAwaitingCompletion.push(processedEventBody.raw);
        ...
        key: '_determineStreamUpdateType',
        value: function _determineStreamUpdateType(buffer) {
            ...
            if (!isString(body)) {
                ...
                console.warn("Received a stream update with an unsupported type:", typeof body === 'undefined' ? 'undefined' : _typeof(body), "- should be of type String", "\n Dump:", body);
            ...
            if (has(this.STREAM_EVENT_BODY_PROCESSING_MAP, eventContainer.event)) {
                ...
                eventContainer = this.STREAM_EVENT_BODY_PROCESSING_MAP[eventContainer.event](eventContainer);
            }

            if (has(this.STREAM_EVENT_EMISSION_OPERATION_MAP, eventContainer.event)) {

                this.STREAM_EVENT_EMISSION_OPERATION_MAP[eventContainer.event](eventContainer);
            }
        }
        ...
        key: '_emitServiceAuthRevokedEvent',
        value: function _emitServiceAuthRevokedEvent() {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'emit', this).call(this, EMITABLE_EVENTS.authTokenRevoked);
        }
        ...
        key: '_emitServiceStreamDataUpdateEvent',
        value: function _emitServiceStreamDataUpdateEvent(dataUpdate) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'emit', this).call(this, EMITABLE_EVENTS.serviceStreamDataUpdate, dataUpdate);
        }
        ...
        key: '_emitServiceStreamClosedEvent',
        value: function _emitServiceStreamClosedEvent() {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'emit', this).call(this, EMITABLE_EVENTS.serviceStreamClosed, this);
        }
        ...
        key: 'addServiceAuthRevokedEventListener',
        value: function addServiceAuthRevokedEventListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'on', this).call(this, EMITABLE_EVENTS.authTokenRevoked, fnCallback);
        ...
        value: function addServiceStreamDataUpdateListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'on', this).call(this, EMITABLE_EVENTS.serviceStreamDataUpdate, fnCallback);
        ...
        key: 'addServiceStreamClosedEventListener',
        value: function addServiceStreamClosedEventListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'on', this).call(this, EMITABLE_EVENTS.serviceStreamClosed, fnCallback);
        ...
        key: 'removeServiceAuthRevokedListener',
        value: function removeServiceAuthRevokedListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'removeListener', this).call(this, EMITABLE_EVENTS.authTokenRevoked, fnCallback);
        ...
        key: 'removeServiceStreamDataUpdateListener',
        value: function removeServiceStreamDataUpdateListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'removeListener', this).call(this, EMITABLE_EVENTS.serviceStreamDataUpdate, fnCallback);
        ...
        key: 'removeServiceStreamClosedEventListener',
        value: function removeServiceStreamClosedEventListener(fnCallback) {

            _get(NestNetworkManager.prototype.__proto__ || Object.getPrototypeOf(NestNetworkManager.prototype), 'removeListener', this).call(this, EMITABLE_EVENTS.serviceStreamClosed, fnCallback);
        ...
        value: function getStructures() {
            ...
            return new RSVP.Promise(function (resolve, reject) {
                ...
                var req = request(fullUrl, function (error, response, body) {
        ...
        key: '_setServiceStream',
        value: function _setServiceStream(options, resolve, reject, repeatRequest) {
            var _this3 = this;

            this.serviceStream = request(options, function (error, response, body) {

                _this3._removeServiceStreamDataListener();

                if (has(_this3.reservedErrorCodes, response.statusCode)) {

                    _this3.reservedErrorCodes[response.statusCode].call(_this3, response, repeatRequest, resolve, reject);
                ...
                if (error) {
                    ...
                    console.error("Request reported error:", error, response);

                    reject(error);
                } else {

                    console.warn("Request ended with response:", body, response);

                    resolve(body);
                }

                _this3._cleanupServiceStream();
            });
        }
        ...
        key: '_removeServiceStreamDataListener',
        value: function _removeServiceStreamDataListener() {

            this.serviceStream.removeListener('data', this.boundStreamListener);
        }
        ...
        key: '_addServiceStreamDataListener',
        value: function _addServiceStreamDataListener() {

            this.serviceStream.on('data', this.boundStreamListener);
        }
        ...
        value: function streamServiceChanges() {
            ...
            return new RSVP.Promise(function (resolve, reject) {
                ...
                if (!isNull(_this4.serviceStream)) {

                    // there is already an active stream from the service
                    // reject with the current service stream
                    reject(_this4.serviceStream);

                    return _this4.serviceStream;
                }

                _this4._createServiceStreamRequest(resolve, reject);
            });
        }
        ...
        key: '_createServiceStreamRequest',
        value: function _createServiceStreamRequest(resolve, reject) {

            var targetUrl = isNull(this.cachedRedirectUrl) ? this.apiUrl : this.cachedRedirectUrl;
            var options = NestNetworkManagerUtils.generateServiceStreamRequestOptions(targetUrl, this.accessToken);

            this._setServiceStream(options, resolve, reject, this._createServiceStreamRequest.bind(this, resolve, reject));
        ...
        key: 'updateDevice',
        value: function updateDevice(deviceData, keyToUpdate, valueToUpdateWith) {
            var _this5 = this;

            return new RSVP.Promise(function (resolve, reject) {

                _this5._createUpdateDeviceRequest(deviceData, keyToUpdate, valueToUpdateWith, resolve, reject);
            });
        }
        ...
        key: '_createUpdateDeviceRequest',
        value: function _createUpdateDeviceRequest(deviceData, keyToUpdate, valueToUpdateWith, resolve, reject) {

            var targetUrl = isNull(this.cachedRedirectUrl) ? this.apiUrl : this.cachedRedirectUrl;

            var options = NestNetworkManagerUtils.generateDeviceUpdateRequestOptions(targetUrl, this.accessToken, deviceData, keyToUpdate, valueToUpdateWith);

            this._putRequest(options, resolve, reject, this._createUpdateDeviceRequest.bind(this, deviceData, keyToUpdate, valueToUpdateWith, resolve, reject));
        }
        ...
        key: '_putRequest',
        value: function _putRequest(options, resolve, reject, repeatRequest) {
            var _this6 = this;

            request(options, function (error, response, body) {

                if (has(_this6.reservedErrorCodes, response.statusCode)) {

                    _this6.reservedErrorCodes[response.statusCode].call(_this6, response, repeatRequest, resolve, reject);
                ...
                if (error) {
                    ...
                    if (!isNull(_this6.cachedRedirectUrl)) {
                        ...
                        _this6._wipeCachedUrl();
                        _this6._putRequest(NestNetworkManagerUtils.generateDeviceUpdateRequestOptions(_this6.apiUrl, _this6.accessToken, deviceData, keyToUpdate, valueToUpdateWith), resolve, reject, deviceData, keyToUpdate, valueToUpdateWith);
                    } else {
        ...
        key: '_handleRedirect',
        value: function _handleRedirect(response, repeatRequest, resolve, reject) {
        ...
        key: '_handleBlocked',
        value: function _handleBlocked(response, repeatRequest, resolve, reject) {

            console.warn("REJECTED DUE TO RATE LIMITATIONS: the WWN API has reported", "that this client has reached its rate limits. Please retry this", "request at a later date");
        ...
        key: '_handleNotFound',
        value: function _handleNotFound(response, repeatRequest, resolve, reject) {

            console.warn("NOT FOUND: the WWN API has reported that the requested path could", "not be found");
        ...
        key: '_handleInternalAPIError',
        value: function _handleInternalAPIError(response, repeatRequest, resolve, reject) {

            console.error("INTERNAL ERROR: the WWN API has reported an internal server error (500)", "please review the request and re-attempt at a later point in time");
        ...
        key: '_handleAuthError',
        value: function _handleAuthError(response, repeatRequest, resolve, reject) {

            console.error("AUTHENTICATION ERROR: the WWN API has reported that the provided", "token is invalid, please set a valid token an retry the request");
        ...
        key: '_handleForbidden',
        value: function _handleForbidden(response, repeatRequest, resolve, reject) {

            console.error("FORBIDDEN: the WWN API has reported that the provided", "path is forbidden to this client. This request should not be repeated.");
        ...
        key: '_handleServiceUnavailable',
        value: function _handleServiceUnavailable(response, repeatRequest, resolve, reject) {

            console.error("SERVICE UNAVAILABLE: the WWN API is not currently available", "to service client requests, please retry at a later time.");
        ...
        key: '_handleInvalidRequest',
        value: function _handleInvalidRequest(response, repeatRequest, resolve, reject) {

            console.error("INVALID REQUEST: the WWN API has reported that the request", "made by this client was not valid. Please revise this request", "before repeating it.");
            ...
            return new RSVP.Promise(function (resolve, reject) {
                ...
                request(options, function (error, response, body) {
                    ...
                    if (error) {
                        ...
                        _this7.setToken(parsedBody.access_token);
