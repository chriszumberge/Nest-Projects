...
(function (document) {
  ...
  var pincodeButton = document.getElementById('pincode-button');
  var cancelPincodeButton = document.getElementById('cancel-pincode-button');
  ...
  if (config.token === "your_token" || config.token === "") {
    ...
    apiButton.addEventListener('click', function () {
      ...
      var OauthUrl = "https://home.nest.com/login/oauth2?client_id=" + config.productID + "&state=" + generatePseudoRandomRange(12);
    ...
    pincodeButton.addEventListener('click', function () {
      ...
      NestApplicationInterface.doOauth(config.productID, config.productSecret, pincodeInput.value).then(function (result) {
